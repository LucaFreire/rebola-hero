...
class Menu(Status_Game):
    ...
    def draw(self, screen):
        screen.fill((0,0,0))
        main_menu = pygame.image.load("./images_menu/07.png")
...
Fundo_Fase = pygame.image.load(path.join("images", "jesuis.png")).convert_alpha()
...
class Level(Status_Game):
    ...
    def draw(self, Tela):
        ...
        Bloco_Red.Insert(RedImg, RedX, RedY), Bloco_Azul.Insert(AzulImg, AzulX, AzulY),
        Bloco_Roxo.Insert(RoxoImg,RoxoX, RoxoY)
        ...
        Mostrar_Pontos(TextoX, TextoY), Mostrar_Vacilos(VacilosX, VacilosY, 6),
Recorde_Pessoal(AltoX, AltoY, "Level")
